...
- **Stakers:** stake `$COBUILD` on budgets to direct allocation, earn rewards on successful budgets.
...
**Mitigations:**
- allocation power is proportional to `$COBUILD` staked (bribes must exceed their own loss from bad allocation)
...
**Mitigations:**
- allocation power is proportional to `$COBUILD` staked — self-dealing is bounded by how much you stake
